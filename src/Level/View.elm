...
import List
import General.Style exposing (levelMainPanel, hoverTopButton, topButtonStyle,
                               item, row, layoutVertical, topBar, topItem,
                               topCenter, topTitles)
...
renderTopBar levelNumber = Html.div [ row, topBar ]
                                    [ sokobanTitle
...
renderActions levelNumber =
    let
        attributes = [ item, topButtonStyle ] ++ hoverTopButton
    in
        Html.div [ topItem 1 ]
...
topContainerItem growth size views = Html.div [ topItem growth
                                              , topCenter
                                              , topTitles size
                                              ]
                                              views
